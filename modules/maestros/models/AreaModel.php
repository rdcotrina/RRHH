...
class AreaModel extends Model{
    ...
    private function _set(){
        ...
        $this->_idArea   = Aes::de(SimpleForm::getParam("_idArea"));    /*se decifra*/
        $this->_area =   SimpleForm::getParam(AARA."txt_area");
        $this->_activo =   SimpleForm::getParam(AARA."chk_activo");
    ...
    /*data para el grid: Area*/
    public function getGridArea(){
        $query = "call sp_maeAreaGrid(:iDisplayStart,:iDisplayLength,:sOrder,:sSearch,:sFilterCols);";
    ...
    /*grabar nuevo registro: Area*/
    public function matenimientoArea(){
        $query = "call sp_maeAreaMantenimiento(:flag,:idArea,:area,:activo,:usuario);";
        $parms = array(
            ':flag' => $this->_flag,
            ':idArea' => $this->_idArea,
            ':area' => $this->_area,
