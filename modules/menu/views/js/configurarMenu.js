var configurarMenu_ = function() {
    ...
    /*listado de modulos*/
    _public.getModulos = function(id) {
        try {
            _private.idDominio = id;
    ...
    _public.getMenuPrincipal = function(id) {
        try {
            _private.idModulo = id;
    ...
    /*dominio a editar*/
    _public.getEditarDominio = function(id) {
        try {
    ...
    /*modulo a editar*/
    _public.getEditarModulo = function(id) {
        try {
    ...
    _public.postDeleteDominio = function(id) {
        try {
            var idDominio = id;
    ...
    _public.postDeleteModulo = function(id) {
        try {
            simpleScript.notify.confirm({
                content: lang.mensajes.MSG_5,
                callbackSI: function() {
    ...
    _public.postDeleteMenuPrincipal = function(id) {
        try {
            simpleScript.notify.confirm({
                content: lang.mensajes.MSG_5,
                callbackSI: function() {
    ...
    _public.postOrdenar = function(tipo,ids) {
        try {
            switch (tipo) {
    ...
    _public.postSortModulos = function(ids) {
        try {
            var textoAreaDividido = ids.split(",");
            var numeroPalabras = textoAreaDividido.length;
    ...
    _public.postSortMenuPrincipal = function(ids) {
        try {
            var textoAreaDividido = ids.split(",");
            var numeroPalabras = textoAreaDividido.length;
